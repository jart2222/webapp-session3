...
<form action="${pageContext.request.contextPath}/productos/form" method="post">
    ...
    <div class="row mb-2">
        <label for="fecha_registro" class="col-form-label col-sm-2">Fecha Registros</label>
        <div class="col-sm-4">
    ...
    <div class="row mb-2">
        <div>
            <input type="submit" class="btn btn-primary" value="${producto.id!=null && producto.id>0?"Editar": "Crear"}">
        </div>
    </div>
